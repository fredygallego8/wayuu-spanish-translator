...
async function bootstrap() {
    ...
    app.enableCors({
        origin: ['http://localhost:3000', 'http://localhost:4000', 'http://localhost:4001', 'http://localhost:5173', 'http://localhost:4200'],
        credentials: true,
    });
    app.useStaticAssets((0, path_1.join)(__dirname, '..', 'data', 'audio'), {
    ...
    `)
        .setVersion('2.0.0')
        .setContact('Equipo de Desarrollo Wayuu', 'https://github.com/your-repo', 'contact@wayuu-translator.com')

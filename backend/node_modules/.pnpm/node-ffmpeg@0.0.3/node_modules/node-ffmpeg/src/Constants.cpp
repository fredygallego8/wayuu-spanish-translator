...
static NAN_METHOD(node_AVERROR) {
    int err;
    if(!TypeConverter::GetArgument(info[0],err)) {
        Nan::ThrowError("First argument must be a valid error code");
        return;
    }
    info.GetReturnValue().Set(Nan::New(AVERROR(err)));
}

static std::unordered_map<std::string,int> constants {
    {"AV_CODEC_CAP_DRAW_HORIZ_BAND",AV_CODEC_CAP_DRAW_HORIZ_BAND},
    {"AV_CODEC_CAP_DR1",AV_CODEC_CAP_DR1},
    {"AV_CODEC_CAP_TRUNCATED",AV_CODEC_CAP_TRUNCATED},
    {"AV_CODEC_CAP_DELAY",AV_CODEC_CAP_DELAY},
    {"AV_CODEC_CAP_SMALL_LAST_FRAME",AV_CODEC_CAP_SMALL_LAST_FRAME},
    {"AV_CODEC_CAP_SUBFRAMES",AV_CODEC_CAP_SUBFRAMES},
    {"AV_CODEC_CAP_EXPERIMENTAL",AV_CODEC_CAP_EXPERIMENTAL},
    ...
    {"AV_CODEC_CAP_PARAM_CHANGE",AV_CODEC_CAP_PARAM_CHANGE},
    ...
    {"AV_CODEC_CAP_LOSSLESS",AV_CODEC_CAP_LOSSLESS},
    {"AV_CODEC_CAP_HARDWARE",AV_CODEC_CAP_HARDWARE},
    {"AV_CODEC_CAP_HARDWARE",AV_CODEC_CAP_HARDWARE},
    {"AV_CODEC_CAP_HYBRID",AV_CODEC_CAP_HYBRID},
    {"AV_CODEC_CAP_ENCODER_REORDERED_OPAQUE",AV_CODEC_CAP_ENCODER_REORDERED_OPAQUE},
    {"AV_CODEC_CAP_ENCODER_FLUSH",AV_CODEC_CAP_ENCODER_FLUSH},
    ...
    {"AV_CH_BOTTOM_FRONT_CENTER",AV_CH_BOTTOM_FRONT_CENTER},
    ...
    {"AV_CODEC_ID_MPEG2VIDEO",AV_CODEC_ID_MPEG2VIDEO}, ///< preferred ID for MPEG-1/2 video decoding
    ...
    /* various PCM "codecs" */
    {"AV_CODEC_ID_FIRST_AUDIO",AV_CODEC_ID_FIRST_AUDIO},     ///< A dummy id pointing at the start of audio codecs
    ...
    {"AV_CODEC_ID_MP3",AV_CODEC_ID_MP3}, ///< preferred ID for decoding MPEG audio layer 1, 2 or 3
    ...
    {"AV_CODEC_ID_GSM",AV_CODEC_ID_GSM}, ///< as in Berlin toast format
    ...
    {"AV_CODEC_ID_GSM_MS",AV_CODEC_ID_GSM_MS}, /* as found in WAV */
    ...
    /* subtitle codecs */
    {"AV_CODEC_ID_FIRST_SUBTITLE",AV_CODEC_ID_FIRST_SUBTITLE},          ///< A dummy ID pointing at the start of subtitle codecs.
    {"AV_CODEC_ID_DVD_SUBTITLE",AV_CODEC_ID_DVD_SUBTITLE},
    {"AV_CODEC_ID_DVB_SUBTITLE",AV_CODEC_ID_DVB_SUBTITLE},
    {"AV_CODEC_ID_TEXT",AV_CODEC_ID_TEXT},  ///< raw UTF-8 text
    ...
    {"AV_CODEC_ID_FIRST_UNKNOWN",AV_CODEC_ID_FIRST_UNKNOWN},           ///< A dummy ID pointing at the start of various fake codecs.
    {"AV_CODEC_ID_TTF",AV_CODEC_ID_TTF},

    {"AV_CODEC_ID_SCTE_35",AV_CODEC_ID_SCTE_35}, ///< Contain timestamp estimated through PCR of program stream.
    ...
    {"AV_CODEC_ID_PROBE",AV_CODEC_ID_PROBE}, ///< codec_id is not known (like AV_CODEC_ID_NONE) but lavf should attempt to identify it

    {"AV_CODEC_ID_MPEG2TS",AV_CODEC_ID_MPEG2TS}, /**< _FAKE_ codec to indicate a raw MPEG-2 TS
                                * stream (only used by libavformat) */
    {"AV_CODEC_ID_MPEG4SYSTEMS",AV_CODEC_ID_MPEG4SYSTEMS}, /**< _FAKE_ codec to indicate a MPEG-4 Systems
                                * stream (only used by libavformat) */
    {"AV_CODEC_ID_FFMETADATA",AV_CODEC_ID_FFMETADATA},   ///< Dummy codec for streams containing only metadata information.
    {"AV_CODEC_ID_WRAPPED_AVFRAME",AV_CODEC_ID_WRAPPED_AVFRAME}, ///< Passthrough codec, AVFrames wrapped in AVPacket
...
void Constants::Init(v8::Local<v8::Object> exports) {
    Nan::Set(exports,Nan::New("AVERROR").ToLocalChecked(),Nan::New<v8::Function>(node_AVERROR));
